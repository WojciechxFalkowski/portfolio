<template>
  <article
    class="relative group flex flex-col w-full gap-y-6 lg:grid lg:grid-cols-2 lg:gap-x-8 lg:items-center col-span-full"
  >
    <div
        ...
        <div class="inline-flex flex-row-reverse justify-end">
          <span
            ...
            ><img
              ...
              class="focus:outline-none"
              tabindex="-1"
              ><span class="absolute inset-0" aria-hidden="true"></span></a
          ></span>
        </div>
